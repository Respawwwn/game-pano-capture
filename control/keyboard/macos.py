...
class MacOSKeyboardHandler(IKeyboardHandler):
    ...
    def __init__(self):
        self._key_codes = {
            ...
            'space': 49, 'enter': 36, 'tab': 48, 'shift': 56, 'cmd': 55,
            'ctrl': 59, 'alt': 58, 'option': 58, 'escape': 53, 'delete': 51
        }
    ...
    def _initialize_quartz(self):
        ...
        try:
            ...
            print("Warning: Quartz not available. Install with: pip install pyobjc-framework-Quartz")
            self._quartz_available = False
    ...
    def press_key_combination(self, key_combination: str) -> bool:
        ...
        try:
            ...
            print(f"macOS: Pressing key combination '{key_combination}' (code: {key_code}, flags: {flags})")
