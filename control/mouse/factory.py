...
class MouseFactory:
    ...
    def create_handler(cls, force_platform: Optional[str] = None) -> IMouseHandler:
        ...
        try:
            ...
            raise ImportError(
                f"Failed to import mouse handler '{handler_module}': {e}"
            ) from e
    ...
    def get_available_platforms(cls) -> list:
        ...
        try:
            ...
            if importlib.util.find_spec(".macos", package="control.mouse"):
        ...
        try:
            ...
            if importlib.util.find_spec(".windows", package="control.mouse"):
        ...
        try:
            ...
            if importlib.util.find_spec(".generic", package="control.mouse"):
